...
# Module-level constant — 40 labelled forensic samples used by EvaluationFramework
# and imported by the /metrics endpoint in main.py
TEST_CASES = [
...
class EvaluationFramework:
    ...
    def run_eval(self, test_cases: List[Dict]):
        ...
        for case in test_cases:
            ...
            # Fix: AnalysisResult exposes `confidence` (0–1), not `risk_score`.
            # Scale to 0–100 for the decision threshold.
            risk_score = beh_analysis.confidence * 100

            # A case is predicted as 'scam' if risk_score > 60, legal myths detected,
            # or protocol violations found.
    ...
    def calculate_metrics(self, results: List[Dict]):
        ...
        return {
            ...
            # Placeholder; the /metrics endpoint overrides this with "live" or "mock"
            "mode": None,
        }
...
if __name__ == "__main__":
    ...
    print(f"Running Eval on {len(TEST_CASES)} samples...")
